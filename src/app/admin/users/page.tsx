...
export default function UsersManagementPage() {
  ...
  const handleRoleUpdate = async (userId: string, newRole: string, userRole: string, currentUserId: string) => {
    // Prevent demoting users with higher roles
    if (roleHierarchy[newRole as keyof typeof roleHierarchy] > roleHierarchy[userRole as keyof typeof roleHierarchy] && newRole !== userRole) {
      toast.error(`Cannot promote users to ${newRole}`)
      return
    }
